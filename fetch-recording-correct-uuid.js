...
const urlEncodedId = 'Jxihfo5yR02%2Fdl5K7jv8aA%3D%3D';
const decodedId = decodeURIComponent(urlEncodedId); // This gives us: Jxihfo5yR02/dl5K7jv8aA==
...
async function fetchRecording() {
    ...
    try {
        ...
        try {
            ...
            const matchingDirs = dirs.filter(dir => dir.includes('Jxihfo5yR02') || dir.includes('dl5K7jv8aA'));
