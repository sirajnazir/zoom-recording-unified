...
const urlEncodedId = 'sEVZ%2Fmd5R9i%2B2XtY%2FFuAEw%3D%3D';
const decodedId = decodeURIComponent(urlEncodedId); // This gives us: sEVZ/md5R9i+2XtY/FuAEw==
...
async function fetchRecording() {
    ...
    try {
        ...
        try {
            ...
            const matchingDirs = dirs.filter(dir => dir.includes('sEVZ') && (dir.includes('md5R9i') || dir.includes('FuAEw')));
