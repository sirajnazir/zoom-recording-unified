...
/**
 * Fix fourth Alan & Aarnav recording
...
const RECORDING = {
    uuid: '2bae0b7762b0c1a2',
    currentFolderId: '1-tTDHE-Z8MErrc7aFDiB2r40ABlYrx6k',
    currentName: 'Coaching_B_unknown_Aarnav_Wk01_2024-10-03_M:2bae0b7762b0c1a2U:2bae0b7762b0c1a2',
    correctName: 'Coaching_B_Alan_Aarnav_Wk01_2024-10-03_M_2bae0b7762b0c1a2U_2bae0b7762b0c1a2',
    coach: 'Alan',
    student: 'Aarnav',
    date: '2024-10-03'
};
...
async function fixAlanAarnavRecording4(drive, sheets) {
    console.log('🔧 Fixing Fourth Alan & Aarnav Recording');
...
async function main() {
    try {
        ...
        await fixAlanAarnavRecording4(drive, sheets);
...
console.log('🚀 Starting fourth Alan & Aarnav recording fix...\n');
