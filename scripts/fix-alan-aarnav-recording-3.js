...
/**
 * Fix third Alan & Aarnav recording
...
const RECORDING = {
    uuid: '1054666e149f9cb4',
    currentFolderId: '1reve35GEsOStZ4itNIvTX1qr33ylqU_d',
    currentName: 'Coaching_B_unknown_Aarnav_Wk01_2024-09-05_M:1054666e149f9cb4U:1054666e149f9cb4',
    correctName: 'Coaching_B_Alan_Aarnav_Wk01_2024-09-05_M_1054666e149f9cb4U_1054666e149f9cb4',
    coach: 'Alan',
    student: 'Aarnav',
    date: '2024-09-05'
};
...
async function fixAlanAarnavRecording3(drive, sheets) {
    console.log('🔧 Fixing Third Alan & Aarnav Recording');
...
async function main() {
    try {
        ...
        await fixAlanAarnavRecording3(drive, sheets);
...
console.log('🚀 Starting third Alan & Aarnav recording fix...\n');
