...
/**
 * Fix fifth Alan & Aarnav recording (Shishir is Aarnav's dad)
 * - Alan is the coach, Aarnav is the student
 * - Fix the incorrect unknown/Shishir naming
...
const RECORDING = {
    uuid: '77aa31328eb37239',
    currentFolderId: '1JNbbheIrQH_ZP3dPHos8kgTlS96N5mAz',
    currentName: 'Coaching_B_unknown_Shishir_Wk01_2024-11-02_M:77aa31328eb37239U:77aa31328eb37239',
    correctName: 'Coaching_B_Alan_Aarnav_Wk01_2024-11-02_M_77aa31328eb37239U_77aa31328eb37239',
    coach: 'Alan',
    student: 'Aarnav',
    date: '2024-11-02',
    note: 'Shishir is Aarnav\'s dad'
};
...
async function fixAlanAarnavRecording5(drive, sheets) {
    console.log('🔧 Fixing Fifth Alan & Aarnav Recording');
    ...
    console.log(`Note: ${RECORDING.note}`);
    ...
    try {
        ...
        // Step 2: Rename the folder with correct coach/student names
        console.log('\n📝 Renaming folder (replacing Shishir with Aarnav)...');
        ...
        // Find Alan folder (should already exist from previous fixes)
            ...
            if (row && row[cols.uuid] === RECORDING.uuid) {
                ...
                if (cols.standardizedName >= 0) {
                    const newStandardizedName = row[cols.standardizedName]
                        ...
                        .replace('Shishir', RECORDING.student)
        ...
        console.log(`- Student: ${RECORDING.student} (Shishir is parent)`);
...
async function main() {
    try {
        ...
        await fixAlanAarnavRecording5(drive, sheets);
...
console.log('🚀 Starting fifth Alan & Aarnav recording fix (Shishir is parent)...\n');
