...
/**
 * Fix second Katie & Iqra recording
...
const RECORDING = {
    uuid: 'd14901d0a3d28539',
    currentFolderId: '1ZkXxeJPisUr-GF-1RNKH5NBvBxF9aANI',
    currentName: 'Coaching_B_Mary_Iqra_Wk01_2025-07-07_M:d14901d0a3d28539U:d14901d0a3d28539',
    correctName: 'Coaching_B_Katie_Iqra_Wk01_2025-07-07_M_d14901d0a3d28539U_d14901d0a3d28539',
    coach: 'Katie',
    student: 'Iqra',
    date: '2025-07-07'
};
...
async function fixKatieIqraRecording2(drive, sheets) {
    console.log('🔧 Fixing Second Katie & Iqra Recording');
    ...
    try {
        ...
        // Find Katie folder (should already exist from previous fix)
        ...
        // Find Iqra folder within Katie (should already exist)
...
async function main() {
    try {
        ...
        await fixKatieIqraRecording2(drive, sheets);
...
console.log('🚀 Starting second Katie & Iqra recording fix...\n');
