...
/**
 * Fix second Rishi & Aaryan recording
...
const RECORDING = {
    uuid: '2f8570c48cf2d763',
    currentFolderId: '1FePJmQsnTjuLKl_RCkFCLJ_3RKInyaHO',
    currentName: 'Coaching_B_Rishi_Aaryan_Wk01_2024-05-09_M:2f8570c48cf2d763U:2f8570c48cf2d763',
    correctName: 'Coaching_B_Rishi_Aaryan_Wk01_2024-05-09_M_2f8570c48cf2d763U_2f8570c48cf2d763',
    coach: 'Rishi',
    student: 'Aaryan',
    date: '2024-05-09'
};
...
async function fixRishiAaryanRecording2(drive, sheets) {
    console.log('🔧 Fixing Second Rishi & Aaryan Recording');
    ...
    try {
        ...
        // Find Rishi folder (should already exist from previous fix)
        ...
        // Find Aaryan folder within Rishi (should already exist)
...
async function main() {
    try {
        ...
        await fixRishiAaryanRecording2(drive, sheets);
...
console.log('🚀 Starting second Rishi & Aaryan recording fix...\n');
