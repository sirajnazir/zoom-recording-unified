...
const urlEncodedId = '01USDLL1S%2BKrMLU2%2B2iUvQ%3D%3D';
const decodedId = decodeURIComponent(urlEncodedId); // This gives us: 01USDLL1S+KrMLU2+2iUvQ==
...
async function fetchRecording() {
    ...
    try {
        ...
        try {
            ...
            const matchingDirs = dirs.filter(dir => dir.includes('01USDLL1S') || dir.includes('KrMLU2') || dir.includes('2iUvQ'));
