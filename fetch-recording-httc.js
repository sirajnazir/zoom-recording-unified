...
const urlEncodedId = 'htTctoK2RT2b%2Fuf8yXaz0w%3D%3D';
const decodedId = decodeURIComponent(urlEncodedId); // This gives us: htTctoK2RT2b/uf8yXaz0w==
...
async function fetchRecording() {
    ...
    try {
        ...
        try {
            ...
            const matchingDirs = dirs.filter(dir => dir.includes('htTctoK2RT2b') || dir.includes('uf8yXaz0w'));
