...
const urlEncodedId = 'vWB0aFM0S6u%2F1lEaJysbjA%3D%3D';
const decodedId = decodeURIComponent(urlEncodedId); // This gives us: vWB0aFM0S6u/1lEaJysbjA==
...
async function fetchRecording() {
    ...
    try {
        ...
        try {
            ...
            const matchingDirs = dirs.filter(dir => dir.includes('vWB0aFM0S6u') || dir.includes('1lEaJysbjA'));
